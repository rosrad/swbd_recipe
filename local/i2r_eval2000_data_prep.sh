...
[ ! -d $sdir/$speechDir ] \
  && echo Expecting directory $sdir/$speechDir to be present && exit 1;
[ ! -d $tdir/reference ] \
...
find $sdir/$speechDir -iname '*.sph' | sort > $dir/sph.flist
...
pem=$sdir/$speechDir/hub5e_00.pem
